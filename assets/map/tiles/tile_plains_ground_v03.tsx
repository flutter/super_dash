...
<tileset version="1.10" tiledversion="1.10.2" name="tile_plains_ground_v03" tilewidth="64" tileheight="64" tilecount="168" columns="12">
 ...
 <tile id="43" type="Slope">
  <properties>
   <property name="LeftTop" type="int" value="0"/>
   <property name="RightTop" type="int" value="45"/>
  </properties>
 </tile>
 <tile id="44" type="Slope">
  <properties>
   <property name="LeftTop" type="int" value="45"/>
   <property name="RightTop" type="int" value="64"/>
  </properties>
 </tile>
 ...
 <tile id="109" type="Platform"/>
 <tile id="111" type="Platform"/>
 <tile id="112" type="Platform"/>
 <tile id="113" type="Platform"/>
 <tile id="127" type="Platform"/>
 <tile id="128" type="Platform"/>
 ...
 <tile id="163" type="Hazard"/>
 <tile id="164" type="Hazard"/>
 <tile id="167" type="Hazard"/>
</tileset>
